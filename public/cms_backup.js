        ...
        <div class="row">
            ...
            <div>
                ...
                <small>
                    ...
                    â€¢ ${article.views} vues
                    ${article.breaking ? " â€¢ ðŸš¨ BREAKING" : ""}
                </small>
        ...
        citizens.innerHTML = `
            <div class="row">
                <div>
                    ...
                    <small>
                        Les nouvelles demandes envoyÃ©es par les citoyens apparaÃ®tront ici.
                    </small>
                </div>
            </div>
        `;
            ...
            return `
                <div class="row">
                    ...
                    <div>
                        ...
                        <small>
                            ðŸ‘¤ ${esc(post.user_name || "Citoyen")}
                            â€¢ ðŸ“Œ ${esc(post.category || "Citoyen")}
                        </small>

                        <small>
                            ðŸ“§ ${esc(post.email || "Aucun email")}
                        </small>
...
editor.onsubmit = async event => {
    ...
    try {
        ...
        alert("Article enregistrÃ© avec succÃ¨s.");
...
async function edit(id) {
    ...
    try {
        ...
        acat.value = article.category || "ActualitÃ©s";
...
async function delA(id) {
    ...
    if (!confirm(
        "Supprimer dÃ©finitivement cet article ?"
    )) {
        return;
    }
...
async function delJob(id) {
    ...
    if (!confirm(
        "Supprimer dÃ©finitivement cette offre ?"
    )) {
        return;
    }
